...
[![My Skills](https://skillicons.dev/icons?i=linux,ubuntu,bash,kubernetes,docker,terraform,gcp,cloudflare,grafana,prometheus,go,py,arduino,c,git,github,vscode,md,latex&theme=light&perline=8)](https://skillicons.dev)
